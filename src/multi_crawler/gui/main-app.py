...
class App(CTk):
    def __init__(self) -> None:
        ...
        # self.sidebar_frame.grid_columnconfigure(1, weight=3)
        ...
        self.config_label.grid(row=0, column=0, columnspan=2, padx=20, pady=(20, 10))

        # create main entry and button
        self.delay_sec_entry = CTkEntry(
            self.sidebar_frame, placeholder_text="sec", width=50
        )
        self.delay_sec_entry.grid(
            row=1,
            column=0,
        )

        self.sidebar_button_1 = CTkButton(
            self.sidebar_frame, command=self.sidebar_button_event, text="초 지연 크롤링"
        )
        self.sidebar_button_1.grid(
            row=1, column=1, padx=(0, 20), pady=10, sticky="nsew"
        )

        self.headless_checkbox = CTkCheckBox(
            master=self.sidebar_frame, text="헤드리스 여부(속도)"
        )
        self.headless_checkbox.grid(
            row=2, column=0, columnspan=2, pady=(20, 0), padx=20, sticky="e"
        )
        ...
        self.optionmenu_1 = CTkOptionMenu(
            self.tabview.tab("CTkTabview"),
            dynamic_resizing=False,
            values=["Value 1", "Value 2", "Value Long Long Long"],
        )
        self.optionmenu_1.grid(row=0, column=0, padx=20, pady=(20, 10))
        self.combobox_1 = CTkComboBox(
            self.tabview.tab("CTkTabview"),
            values=["Value 1", "Value 2", "Value Long....."],
        )
        self.combobox_1.grid(row=1, column=0, padx=20, pady=(10, 10))
        self.string_input_button = CTkButton(
            self.tabview.tab("CTkTabview"),
